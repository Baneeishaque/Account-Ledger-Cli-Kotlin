...
fun listAccountsFull(username: String?, userId: Int) {

    println("Contacting Server...")
    val apiResponse = getAccountsFull(userId = userId)
...
fun chooseDepositFull(userId: Int): AccountResponse? {
    ...
    val apiResponse: ResponseHolder<AccountsResponse> = getAccountsFull(userId)
    if (apiResponse.isError()) {
